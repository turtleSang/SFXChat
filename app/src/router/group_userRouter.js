...
const {getListGroup, createGroup, checkRenderNewGroup, getMemberOfGroup, leaveGroup} = require("../controllers/group_user.controller");
...
routerGroup.delete("/leavegroup/:groupId", authenticate, leaveGroup);
